...
export async function renderFolderView(items, path, request) {
  ...
  const intro = `
  <div class="mdui-card mdui-shadow-8 mdui-hoverable" style="margin-top: 30px;">
    <div class="mdui-card-header">
      <img class="mdui-card-header-avatar" src="https://sakurapuare.com/wp-content/uploads/2021/05/favicon.ico" />
      <div class="mdui-card-header-title">SakuraPuare</div>
      <div class="mdui-card-header-subtitle">记录心情，记录生活</div>
    </div>
  </div>
    <div class="intro markdown-body" style="text-align: left; margin-top: 2rem;">
      <h2>Yoo, I'm SakuraPuare 👋</h2>
      <p>This is my OneDrive public directory listing. Feel free to download any files that you find useful.</p>
      <p><a href="https://sakurapuare.com">Home</a> & <a href="https://github.com/sakurapuare">GitHub</a></p>
    </div>`
